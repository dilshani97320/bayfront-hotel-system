...
<body>
	<div class="containerheader">
		...
		<div class="slideshowContainer">
			...
			<img class="imageSlides" src="img/slide1.jpg" alt="beach side city view">
			<img class="imageSlides" src="img/slide2.jpg" alt="leaf on the ground">
			<img class="imageSlides" src="img/slide3.jpg" alt="lake surrounded by mountains">
