...
.line-style { 
  border: 0; 
  height: 3px; 
  background-image: -webkit-linear-gradient(left, #f0f0f0, #0de9df, #f0f0f0);
  background-image: -moz-linear-gradient(left, #f0f0f0, #0de9df, #f0f0f0);
  background-image: -ms-linear-gradient(left, #f0f0f0, #0de9df, #f0f0f0);
  background-image: -o-linear-gradient(left, #f0f0f0,#0de9df, #f0f0f0); 
}
...
<body>
	<?php include("common/header-surf.php"); ?>
	<?php include("common/surf-service-section.php"); ?>

	<div class="section1" >
		
		<div class="content imgsec ">
			<img src="other/h1-video-img.jpg">
		</div>
	...
	<div class="section2" >
      ...
      <ul class="p1">
		...
		<div class="part pack1">
			<figure class="imgBlock"><img class="img1" src="other/29.jpg">
  					<div class="title">
    					<div>
					      <h3>group lesons</h3>
					      <h5>Book now</h5>
		...
		<div class="part pack2">
			<figure class="imgBlock"><img class="img2" src="other/32.jpg">
  					<div class="title">
    					<div>
					      <h3>Solo lesons</h3>
					      <h5>book now</h5>
